...
const ProjectCard: React.FC<ProjectCardProps> = ({ project, onClick, index }) => {
  ...
  useEffect(() => {
    ...
    const handleMouseEnter = () => {
      ...
      // Overlay fade with backdrop blur
      .to(overlay, {
        opacity: 1,
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-lg bg-gray-900 aspect-[4/5] shadow-2xl">
        ...
        <div className="absolute top-6 right-6 w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-500 border border-white/20">
